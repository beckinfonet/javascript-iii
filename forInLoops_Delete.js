...
// CODE HERE
const greaterThan10 = function(obj){
  for ( var prop in obj){
    if ( obj[prop] > 10){
      obj[prop] = 0;
    }
...
// Write a for in loop that loops over the object. If the property name starts with an 'sh', concatenate the value to the string variable. 
// By the end of the for in loop, you should have a sentence, return that sentence.

// CODE HERE
const secrets = function(obj){
  let data = '';
...
// Sometimes it's needed to delete object properties. All you need is the word delete before a reference to the object property value. 
...
// CODE HERE
const removePassword = function(obj){
  delete obj.password;
  return obj;
}
...
// Write a function called startsWithK that takes an object as a parameter. Write a for in loop to loop over the object. 
// If any property name starts with k, delete that property. Return the updated object.

// CODE HERE
const startsWithK = function(obj){
  for ( var key in obj){
    if(key.startsWith('k')){
      delete obj[key];
    }
...
// CODE HERE
const hiddenTreasure = function(obj){
  for ( var key in obj){
